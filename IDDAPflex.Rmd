...
-----------------------------------------------------------------------
### Sorting Criteria {data-height=200}
```{r}
renderTable({
  if(is.null(input$file1))
  return()
  newdata<-read_csv(input$file1$datapath)
  headers= colnames(newdata)} 
  
  sliderInput('age', "Age Ran
            ge", min = 0, max = 110, value=c(0, 110) )
})
```
...
renderTable({
  ...
  return()
  newdata<-read_csv(input$file1$datapath)
  # () for when you want it to be the file uploaded

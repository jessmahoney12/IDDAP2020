...
library(DT)
newdata=read.csv("/Users/jessmahoney/Desktop/capstoneR/IDDAP2020/mdata.csv",stringsAsFactors=FALSE, check.names = FALSE)
...
-----------------------------------------------------------------------
```{r}
h6("Infectious Disease Data Analysis Program (IDDAP) serves as a proof of concept for a user-friendly data
